...
namespace Gerenciamento_EvolutionSchool.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class TurmaController : ControllerBase
    {
        private readonly Gerenciamento_EvolutionSchool_Context _context;

        public TurmaController(Gerenciamento_EvolutionSchool_Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Turma>> PostTurma(Turma turma)
        {
          if (_context.Turma == null)
          {
              return Problem("Entity set 'Gerenciamento_EvolutionSchool_Context.Turma'  is null.");
          }
